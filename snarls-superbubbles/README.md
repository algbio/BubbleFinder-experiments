# Snarls & Superbubbles Benchmark

Snakemake pipeline for the experiments in:

> F. Sena, A. Politov, C. Moumard, M. Cáceres, S. Schmidt, J. Harviainen, A. I. Tomescu.
> *Identifying all snarls and superbubbles in linear-time, via a unified SPQR-tree framework.*
> [arXiv:2511.21919](https://arxiv.org/abs/2511.21919), 2025.

---

This pipeline **can** (depending on the requested Snakemake targets and on the configuration in `datasets.yaml`):
...
cd BubbleFinder-experiments/snarls-superbubbles
